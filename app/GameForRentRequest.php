...
class GameForRentRequest extends Model
{
  ...
  protected $fillable = ['user_id', 'game_for_rent_id', 'rent_type_id', 'address_id', 'game_price', 'rent_price', 'is_sent', 'is_delivered', 'is_finish', 'is_returned', 'penalty_cost', 'finished_at'];
