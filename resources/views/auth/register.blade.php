...
{{--                        <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">--}}
                        <form method="POST" action="{{ route('/') }}" aria-label="{{ __('Register') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="mobile_number" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="mobile_number" value="{{ old('mobile_number') }}" required autofocus>
