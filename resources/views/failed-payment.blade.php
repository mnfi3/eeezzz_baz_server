...
<div class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class=" mt-5 text-center" style="color: lightgrey;font-weight: 400;font-size: 13px;color:gray; padding: 0px 15px ">در صورت کسر وجه،ظرف مدت 1 الی 72 ساعت به حساب شما عودت داده می شود</div>
